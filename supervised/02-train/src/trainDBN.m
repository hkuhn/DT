...
for iter=1:MaxIter
	...
	for batch=1:BatchSize:num		
        ...
        for n=nrbm:-1:strbm
            ...
            if( n+1 > nrbm )
                ...
                %der = bsxfun(@minus, Hall{nrbm}, OUT(bind,:));
            ...
            if( DropOutRate > 0 )
                ...
                %deltaDbn.rbm{n}.W = bsxfun(@minus, deltaDbn.rbm{n}.W, StepRatio * deltaW);
                deltaDbn.rbm{n}.b = deltaDbn.rbm{n}.b - StepRatio * deltab;
            end
        end
        ...
        for n=strbm:nrbm            
            ...
            %dbn.rbm{n}.W = bsxfun(@plus, dbn.rbm{n}.W, deltaDbn.rbm{n}.W); 
    ...
    if( Verbose )
        ...
        out = v2h( tdbn, IN );
        err = power( OUT - out, 2 );
        %err = power(bsxfun(@minus, OUT, out), 2);
